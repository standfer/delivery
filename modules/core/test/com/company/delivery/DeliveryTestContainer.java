...
public class DeliveryTestContainer extends TestContainer {

    public DeliveryTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/delivery/app.properties",
    ...
    public static class Common extends DeliveryTestContainer {

        public static final DeliveryTestContainer.Common INSTANCE = new DeliveryTestContainer.Common();
